            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="dashboard-box margin-top-0">
                  <div className="headline">
                    <h3>
                      <i className="icon-feather-folder-plus"></i> Task
                      Submission Form
                    </h3>
                  </div>
                        ...
                        <div className="submit-field">
                          ...
                          <div className="feedback-yes-no margin-top-0">
                            <div className="radio">
                              ...
                              />
                              <label for="radio-1">
                                <span className="radio-label"></span> Fixed
                                Price Project
                              </label>
                            </div>
                            ...
                            <div className="radio">
                              ...
                              <label for="radio-2">
                                <span className="radio-label"></span> Hourly
                                Project
                              </label>
                            </div>
                          </div>
              ...
              <div className="col-xl-12">
                <a href="#" className="button ripple-effect big margin-top-30">
                  <i className="icon-feather-plus"></i> Post a Task
                </a>
              </div>
            </div>
